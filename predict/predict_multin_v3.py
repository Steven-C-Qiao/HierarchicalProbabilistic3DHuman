...
def predict_poseMF_shapeGaussian_net(pose_shape_model,
    ...
    for image_fname in tqdm(['front_Apose.jpg', 'diag_Apose.jpg', 'side_Apose.jpg']):#[f for f in os.listdir(image_dir) if f.endswith(('front_Apose.jpg', 'side_Apose.jpg', 'back_Apose.jpg'))]):
        with torch.no_grad():
