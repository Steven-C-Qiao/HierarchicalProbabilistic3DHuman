...
def predict_poseMF_shapeGaussian_net(pose_shape_model,
    ...
    for image_fname in tqdm(['front_Apose.jpg', 'side_Apose.jpg', 'diag_Apose.jpg']):#[f for f in os.listdir(image_dir) if f.endswith(('front_Apose.jpg', 'side_Apose.jpg', 'back_Apose.jpg'))]):
        with torch.no_grad():
    ...
    vertex_var_colours = plt.cm.jet(vertex_var_norm(per_vertex_3Dvar.numpy()), alpha=0.5)[:, :3]
