...
#from train.validate_somehow_better import train_val_vis
from train.validate import train_multin as train_val_vis
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', '-C', type=str, default="/scratches/kyuban/cq244/multin_v2/experiments/multin_v4_002/saved_models/epoch_085.tar")
    parser.add_argument('--gpu', type=int, default=1)
    parser.add_argument('--baseline', type=bool, default=False)

    args = parser.parse_args()
    #args.ckpt = "/scratches/kyuban/cq244/multin_v2/experiments/multin_v4_002/saved_models/epoch_299.tar"
    args.ckpt = "/scratches/kyuban/cq244/multin_v2/experiments/multin_v3_001/saved_models/epoch_299.tar"

    if args.baseline==True:
         args.save_dir = "./val_vis/baseline/"
