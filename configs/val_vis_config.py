...
_C.TRAIN.SYNTH_DATA.AUGMENT.SMPL.SHAPE_STD = 0.01

_C.TRAIN.SYNTH_DATA.AUGMENT.CAM = CfgNode()
_C.TRAIN.SYNTH_DATA.AUGMENT.CAM.XY_STD = 0.01
_C.TRAIN.SYNTH_DATA.AUGMENT.CAM.DELTA_Z_RANGE = [-0., 0.]

_C.TRAIN.SYNTH_DATA.AUGMENT.BBOX = CfgNode()
_C.TRAIN.SYNTH_DATA.AUGMENT.BBOX.DELTA_SCALE_RANGE = [-0.01, 0.01]
_C.TRAIN.SYNTH_DATA.AUGMENT.BBOX.DELTA_CENTRE_RANGE = [-0.01, 0.01]
...
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.REMOVE_PARTS_PROBS = [0, 0, 0, 0, 0, 0, 0.05, 0.05, 0.05, 0.05, 0, 0,
                                                            0, 0, 0.05, 0.05, 0.05, 0.05, 0, 0, 0, 0, 0.05, 0.05]
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.REMOVE_APPENDAGE_JOINTS_PROB = 0.
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.REMOVE_JOINTS_INDICES = [7, 8, 9, 10, 13, 14, 15, 16]  # COCO joint labels
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.REMOVE_JOINTS_PROB = 0.
...
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.OCCLUDE_BOX_PROB = 0
...
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.EXTREME_CROP_PROB = 0
...
_C.LOSS.STAGE1.WEIGHTS.SILHOUETTE = 200.0
...
_C.LOSS.STAGE2.WEIGHTS.SILHOUETTE = 200.0
