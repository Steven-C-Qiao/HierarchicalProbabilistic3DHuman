...
from predict.predict_multin_v4 import predict_poseMF_shapeGaussian_net
...
def run_predict(device,
    ...
    pose_shape_dist_model = MultinV3(smpl_parents=smpl_immediate_parents,
    ...
    #pose_shape_dist_model.load_state_dict(checkpoint['model_state_dict'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pose_shape_weights', '-W3D', type=str, default=None)
